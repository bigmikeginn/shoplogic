      ...
      <div className="w-full max-w-md">
        ...
        <div className="form-compact">
          ...
          <div className="space-y-2 pb-3 border-b border-gray-700">
            <label className="flex items-center gap-2 p-2 sm:p-3 bg-gray-800 bg-opacity-30 rounded-lg cursor-pointer hover:bg-opacity-50 transition border border-gray-700 text-sm">
              <input
                type="radio"
                value="tangential"
        ...
        {/* Results */}
        {result && (
          <div className="mt-3 sm:mt-4 lg:mt-5 p-4 sm:p-5 lg:p-6 bg-gradient-to-br from-amber-500 to-orange-600 rounded-lg shadow-lg border border-amber-400">
            <h3 className="font-bold text-responsive-base sm:text-responsive-lg text-white mb-2 sm:mb-3">Seasonal Movement</h3>

            <div className="space-y-2 mb-3">
              <div className="bg-gray-900 bg-opacity-50 p-3 sm:p-4 rounded-lg border border-amber-400">
