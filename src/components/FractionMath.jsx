              ...
              <div className="grid grid-cols-4 gap-2">
                {['+', '−', '×', '÷'].map((op) => (
                  <button
                    ...
                    className={`py-2 rounded-lg font-bold transition text-sm sm:text-base ${
                      operator === op
                        ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white'
                        : 'bg-gray-800 bg-opacity-50 text-gray-300 border border-gray-700 hover:bg-opacity-70'
                    }`}
        ...
        {tab === 'convert' && (
          <div className="space-y-3 sm:space-y-4">
            <div className="space-y-2 pb-3 border-b border-gray-700">
              <label className="flex items-center gap-2 p-2 sm:p-3 bg-gray-800 bg-opacity-30 rounded-lg cursor-pointer hover:bg-opacity-50 transition border border-gray-700">
                <input
                  type="radio"
                  name="convert"
            ...
            {/* Conversion Result */}
            {conversionResult && (
              <div className="mt-3 sm:mt-4 lg:mt-5 p-4 sm:p-5 lg:p-6 bg-gradient-to-br from-purple-500 to-pink-600 rounded-lg shadow-lg border border-purple-400 space-y-2">
