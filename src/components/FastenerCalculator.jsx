      ...
      <div className="w-full max-w-md">
        ...
        {tab === 'pilot' && (
          <div className="form-compact">
            ...
            {result?.type === 'pilot' && (
              <div className="mt-3 sm:mt-4 lg:mt-5 p-4 sm:p-5 lg:p-6 bg-gradient-to-br from-green-500 to-emerald-600 rounded-lg shadow-lg border border-green-400">
        ...
        {tab === 'layout' && (
          <div className="form-compact">
            ...
            {result?.type === 'layout' && (
              <div className="mt-3 sm:mt-4 lg:mt-5 p-4 sm:p-5 lg:p-6 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-lg shadow-lg border border-blue-400">
                ...
                {result.data.error ? (
                  ...
                  <div className="space-y-2">
                    <div className="bg-gray-900 bg-opacity-50 p-2 sm:p-3 rounded-lg border border-blue-400">
                    ...
                    <div className="bg-gray-900 bg-opacity-50 p-2 sm:p-3 rounded-lg border border-blue-400 text-xs font-mono">
        ...
        {tab === 'app' && (
          <div className="form-compact">
            ...
            {result?.type === 'app' && result.data && (
              <div className="mt-3 sm:mt-4 lg:mt-5 p-4 sm:p-5 lg:p-6 bg-gradient-to-br from-purple-500 to-pink-600 rounded-lg shadow-lg border border-purple-400">
                <h3 className="font-bold text-responsive-base sm:text-responsive-lg text-white mb-3">{result.data.application}</h3>
                <div className="space-y-2">
                  <div className="bg-gray-900 bg-opacity-50 p-2 sm:p-3 rounded-lg border border-purple-400">
