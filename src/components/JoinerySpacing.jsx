    ...
    <div className="w-full min-h-screen p-3 sm:p-4 lg:p-6 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex flex-col items-center justify-center">
      <div className="w-full max-w-md">
        ...
        <div className="form-compact">
          ...
          {result && !result.error && (
            <div className="p-3 sm:p-4 rounded-lg bg-gradient-to-br from-blue-500 to-cyan-600 border border-blue-400">
          ...
          {result?.error && (
            <div className="p-3 sm:p-4 rounded-lg bg-gradient-to-br from-red-500 to-pink-600 border border-red-400 text-xs text-red-100">
              {result.error}
            </div>
          )}
        </div>
        ...
        {result && result.layout && (
          <div className="mt-3 sm:mt-4 lg:mt-5 p-4 sm:p-5 lg:p-6 bg-gray-800 bg-opacity-50 rounded-lg border border-gray-700">
            <h3 className="font-bold text-responsive-base sm:text-responsive-lg text-white mb-3">Layout Diagram</h3>

            {/* SVG Layout */}
            <div className="bg-gray-900 p-3 sm:p-4 rounded-lg mb-3 overflow-x-auto">
              <svg
                width="100%"
                height="80"
