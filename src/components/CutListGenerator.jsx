      ...
      <div className="w-full max-w-lg">
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="space-y-1 max-h-48 sm:max-h-64 overflow-y-auto scrollbar-styled mb-3 pb-3 border-b border-gray-700">
            {parts.map((part, idx) => (
              <div key={idx} className="p-2 sm:p-3 bg-gray-800 bg-opacity-30 rounded-lg border border-gray-700 text-xs sm:text-sm">
          ...
          <div className="form-compact">
            ...
            <button
              ...
              className="w-full px-3 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white text-sm rounded-lg hover:shadow-lg transition font-semibold"
            >
              + Add
            </button>
          </div>
          ...
          {result && (
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-3">
                <div className="bg-gradient-to-br from-blue-500 to-cyan-600 p-3 sm:p-4 rounded-lg border border-blue-400">
                ...
                <div className="bg-gradient-to-br from-green-500 to-emerald-600 p-3 sm:p-4 rounded-lg border border-green-400">
                ...
                <div className="bg-gradient-to-br from-purple-500 to-pink-600 p-3 sm:p-4 rounded-lg border border-purple-400">
                ...
                <div className="bg-gradient-to-br from-orange-500 to-red-600 p-3 sm:p-4 rounded-lg border border-orange-400">
